...
- Integration points with existing systems (Supabase, Stripe, etc.)
...
- **All DB changes** need a migration file in `supabase/migrations/`
- **All secrets** must reference environment variables (never hardcode)
