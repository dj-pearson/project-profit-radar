          ...
          <nav className="border-b bg-background/95 backdrop-blur-sm">
            <div className="flex justify-between h-14 sm:h-16 px-3 sm:px-4 lg:px-6">
              <div className="flex items-center min-w-0 flex-1">
                ...
                <h1 className="text-base sm:text-lg lg:text-2xl font-bold text-foreground truncate">Leads Management</h1>
              </div>
                  ...
                  {leadsLoading ? (
                    ...
                    <div className="space-y-4">
                      {filteredLeads.map((lead) => (
                        <div key={lead.id} className="border rounded-lg p-4 hover:bg-muted/50 transition-colors cursor-pointer"
