...
const ProjectDetail = () => {
  ...
  const [addChangeOrderDialogOpen, setAddChangeOrderDialogOpen] =
    useState(false);
  ...
  const [addExistingContactDialogOpen, setAddExistingContactDialogOpen] =
    useState(false);
  ...
  const [isEditSubmittalDialogOpen, setIsEditSubmittalDialogOpen] =
    useState(false);
  ...
  const [editChangeOrderDialogOpen, setEditChangeOrderDialogOpen] =
    useState(false);
    ...
    try {
      ...
      if (projectId && contactResult) {
        ...
        if (projectContactError) {
          console.error(
            "Error linking contact to project:",
            projectContactError
          );
        }
      }
  ...
  const handleAddExistingContact = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "Failed to add contact to project. Contact may already be assigned this role.",
        variant: "destructive",
      });
    }
  };
  ...
  const handleCreatePermit = async () => {
    try {
      const { error } = await supabase.from("environmental_permits").insert({
  ...
  const handleCreateJobCost = async () => {
    try {
      const { error } = await supabase.from("job_costs").insert({
        ...
        labor_cost:
          newJobCost.cost_type === "labor" ? newJobCost.actual_cost : 0,
        material_cost:
          newJobCost.cost_type === "material" ? newJobCost.actual_cost : 0,
        equipment_cost:
          newJobCost.cost_type === "equipment" ? newJobCost.actual_cost : 0,
        other_cost:
          newJobCost.cost_type === "other" ? newJobCost.actual_cost : 0,
  ...
  const handleCreateRfi = async () => {
    try {
      const { error } = await supabase.from("rfis").insert({
        ...
        created_by: user?.id,
        rfi_number:
          newRfi.rfi_number || `RFI-${Date.now().toString().slice(-8)}`,
      });
  ...
  const handleCreateSubmittal = async () => {
    ...
    try {
      ...
      const submittalNumber = `SUB-${new Date().getFullYear()}-${submittalCount
        .toString()
        .padStart(3, "0")}`;
  ...
  const handleUpdateSubmittal = async () => {
    if (
      !editingSubmittal ||
      !editedSubmittal.title ||
      !editedSubmittal.description
    ) {
      toast({
        variant: "destructive",
        title: "Validation Error",
  ...
  const handleCreatePunchListItem = async () => {
    ...
    try {
      console.log("Creating punch list item with data:", {
        item_number:
          newPunchListItem.item_number ||
          `PLI-${Date.now().toString().slice(-8)}`,
        ...
        <div className="flex-1">
          ...
          <div className="flex h-[calc(100vh-4rem)]">
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                >
                            ...
                            <CardContent>
                              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm">
                                    $
                                    {phase.actual_cost?.toLocaleString() || "0"}
                                  </p>
                                </div>
                              </div>
                            </CardContent>
                    ...
                    {materials.length === 0 ? (
                      <Card>
                        <CardContent className="text-center py-8">
                          ...
                          <p className="text-muted-foreground">
                            Track materials specific to this project
                          </p>
                          <Dialog
                            open={createMaterialDialogOpen}
                            onOpenChange={setCreateMaterialDialogOpen}
                    ...
                    {reports.length === 0 ? (
                      <Card>
                        <CardContent className="text-center py-8">
                          ...
                          <p className="text-muted-foreground">
                            Daily progress reports for this project
                          </p>
                          <Dialog
                      ...
                      <Card>
                        <CardContent className="text-center py-8">
                          ...
                          <p className="text-muted-foreground mb-4">
                            No permits added to this project yet
                          </p>
                          <Button onClick={() => setAddPermitDialogOpen(true)}>
                            <Plus className="h-4 w-4 mr-2" />
                            Add First Permit
                            ...
                            <CardHeader>
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  ...
                                  >
                                    {permit.application_status?.replace(
                                      "_",
                                      " "
                                    ) || "not applied"}
                                  </Badge>
                    ...
                    {warrantiesLoading ? (
                      ...
                      <Card>
                        <CardContent className="text-center py-8">
                          ...
                          <p className="text-muted-foreground mb-4">
                            No warranties added to this project yet
                          </p>
                          <Button
                            onClick={() => setAddWarrantyDialogOpen(true)}
                          >
                            <Plus className="h-4 w-4 mr-2" />
                            Add First Warranty
                          </Button>
                          ...
                          <Card key={warranty.id}>
                            <CardHeader>
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  <Badge variant="outline">
                                    {warranty.warranty_type || "General"}
                                  </Badge>
                                  <CardTitle className="text-lg">
                                    {warranty.item_name}
                                  </CardTitle>
                              ...
                              <div className="space-y-3">
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <p>
                                      {warranty.warranty_duration_months || 12}{" "}
                                      months
                                    </p>
                                  </div>
                                </div>
                  ...
                  <TabsContent value="contacts" className="space-y-6">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Dialog
                          open={addExistingContactDialogOpen}
                          onOpenChange={setAddExistingContactDialogOpen}
                        >
                          <DialogTrigger asChild>
                                  ...
                                  <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                      <div className="w-10 h-10 rounded-full bg-construction-blue flex items-center justify-center text-white text-sm font-medium">
                                        {projectContact.contact.first_name?.[0]}
                                        {projectContact.contact.last_name?.[0]}
                                      </div>
                                      <div>
                                        <CardTitle className="text-sm">
                                          {projectContact.contact.first_name}{" "}
                                          {projectContact.contact.last_name}
                                        </CardTitle>
                                        <Badge
                                          variant="outline"
                                          className="text-xs"
                  ...
                  <TabsContent value="communication" className="space-y-6">
                    <div className="flex justify-between items-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Direct messaging with clients and team members
                      </p>
                    </div>
                    ...
                    {jobCosts.length === 0 ? (
                      <Card>
                        <CardContent className="text-center py-8">
                          <DollarSign className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                          <p className="text-muted-foreground">
                            Track labor, material, and equipment costs for this
                            project
                          </p>
                          <Button
                            variant="outline"
                            onClick={navigateToJobCosting}
                            className="mt-4"
                          >
                            Add First Job Cost
                          </Button>
                  ...
                  <TabsContent value="rfis" className="space-y-6">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Dialog
                          open={addRfiDialogOpen}
                          onOpenChange={setAddRfiDialogOpen}
                        >
                          <DialogTrigger asChild>
                            <Button>
                              <Plus className="h-4 w-4 mr-2" />
                    ...
                    {rfis.length === 0 ? (
                      <Card>
                        <CardContent className="text-center py-8">
                          ...
                          <Button
                            onClick={() => setAddRfiDialogOpen(true)}
                            className="mt-4"
                          >
                            <Plus className="h-4 w-4 mr-2" />
                            Create First RFI
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Dialog
                          ...
                          onOpenChange={setAddSubmittalDialogOpen}
                        >
                          <DialogTrigger asChild>
                            <Button>
                              <Plus className="h-4 w-4 mr-2" />
                    ...
                    {submittals.length === 0 ? (
                      <Card>
                        <CardContent className="text-center py-8">
                          <FileText className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                          <p className="text-muted-foreground">
                            No submittals for this project yet
                          </p>
                          <Button
                  ...
                  <TabsContent value="changeorders" className="space-y-6">
                    <div className="flex justify-between items-center">
                      ...
                      <Dialog
                        open={addChangeOrderDialogOpen}
                        onOpenChange={setAddChangeOrderDialogOpen}
                      >
                        <DialogTrigger asChild>
                          <Button>
                            <Plus className="h-4 w-4 mr-2" />
                      ...
                      <Card>
                        <CardContent className="text-center py-8">
                          ...
                          <p className="text-sm text-muted-foreground mt-2">
                            Track project changes and cost adjustments
                          </p>
                        </CardContent>
                      </Card>
                    ) : (
                        ...
                        {changeOrders.map((order: any) => (
                          <Card key={order.id}>
                            ...
                            <CardContent className="pt-0">
                              ...
                              {order.assigned_approvers &&
                                order.assigned_approvers.length > 0 && (
                                  <p className="text-xs sm:text-sm text-muted-foreground mt-1">
                                    <span className="font-medium">
                                      Approvers:
                                    </span>{" "}
                                    {order.assigned_approvers.length} assigned
                                  </p>
                                )}
                            </CardContent>
                          </Card>
                  ...
                  <TabsContent value="punchlist" className="space-y-6">
                    <div className="flex justify-between items-center">
                      ...
                      <Dialog
                        open={addPunchListDialogOpen}
                        onOpenChange={setAddPunchListDialogOpen}
                      >
                        <DialogTrigger asChild>
                          <Button>
                            <Plus className="h-4 w-4 mr-2" />
                      ...
                      <Card>
                        <CardContent className="text-center py-8">
                          ...
                          <Button
                            variant="outline"
                            className="mt-4"
                            onClick={() => setAddPunchListDialogOpen(true)}
                          >
                  ...
                  <TabsContent value="equipment" className="space-y-6">
                    ...
                    <Card>
                      <CardContent className="text-center py-8">
                        <Wrench className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                        <p className="text-muted-foreground">
                          Manage equipment and tools for this project
                        </p>
                      </CardContent>
                    </Card>
                  </TabsContent>
                  ...
                  {editingTask && (
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <Label htmlFor="edit-task-actual-hours">
                            Actual Hours
                          </Label>
                          <Input
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <Label htmlFor="edit-task-progress">
                            Progress ({editingTask.completion_percentage}%)
                          </Label>
                          <Slider
              ...
              >
                <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          value={
                            newReport.crew_count === 0
                              ? ""
                              : newReport.crew_count
                          }
                          onChange={(e) =>
                            setNewReport((prev) => ({
                              ...prev,
                    ...
                    <div>
                      <Label htmlFor="materials-delivered">
                        Materials Delivered
                      </Label>
                      <Textarea
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setCreateMaterialDialogOpen(false)}
                      >
                        Cancel
                      </Button>
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setAddTeamMemberDialogOpen(false)}
                      >
                        Cancel
                      </Button>
                      <Button
              ...
              {/* Add Job Cost Dialog */}
              <Dialog
                open={addJobCostDialogOpen}
                onOpenChange={setAddJobCostDialogOpen}
              >
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setAddJobCostDialogOpen(false)}
                      >
                        Cancel
                      </Button>
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setNewRfi((prev) => ({ ...prev, priority: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setAddRfiDialogOpen(false)}
                      >
                        Cancel
                      </Button>
                      <Button onClick={handleCreateRfi}>Add RFI</Button>
                    </div>
                  </div>
                </DialogContent>
              </Dialog>
              ...
              >
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="submittal-number">
                          Submittal Number
                        </Label>
                        <Input
                          id="submittal-number"
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setAddSubmittalDialogOpen(false)}
                      >
                        Cancel
                      </Button>
              ...
              <Dialog
                open={isEditSubmittalDialogOpen}
                onOpenChange={setIsEditSubmittalDialogOpen}
              >
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="edit-submittal-description">
                        Description
                      </Label>
                      <Textarea
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="edit-submittal-spec">
                          Spec Section
                        </Label>
                        <Input
                      ...
                      <div>
                        <Label htmlFor="edit-submittal-priority">
                          Priority
                        </Label>
                        <Select
                          value={editedSubmittal.priority}
                          onValueChange={(value) =>
                            setEditedSubmittal((prev) => ({
                              ...prev,
                              priority: value,
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="edit-submittal-due-date">
                          Due Date
                        </Label>
                        <Input
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setIsEditSubmittalDialogOpen(false)}
                      >
                        Cancel
                      </Button>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto mx-4">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="change-order-number">
                          Change Order Number
                        </Label>
                        <Input
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setAddChangeOrderDialogOpen(false)}
                      >
                        Cancel
                      </Button>
              ...
              <Dialog
                open={editChangeOrderDialogOpen}
                onOpenChange={setEditChangeOrderDialogOpen}
              >
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto mx-4">
                  <DialogHeader>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            value={editingChangeOrder.change_order_number}
                            disabled
                          />
                        </div>
                        <div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="material_upgrade">
                              Material Upgrade
                            </SelectItem>
                            <SelectItem value="unforeseen_conditions">
                              Unforeseen Conditions
                            </SelectItem>
                            <SelectItem value="client_request">
                              Client Request
                            </SelectItem>
                            <SelectItem value="code_requirement">
                              Code Requirement
                            </SelectItem>
                            <SelectItem value="other">Other</SelectItem>
                          </SelectContent>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Select
                            value={
                              editingChangeOrder.assigned_approvers?.[0] || ""
                            }
                            onValueChange={(value) =>
                              setEditingChangeOrder({
                                ...editingChangeOrder,
                            ...
                            <PopoverTrigger asChild>
                              <Button
                                ...
                                className={cn(
                                  ...
                                  !editingChangeOrder.approval_due_date &&
                      ...
                      <div className="flex justify-end space-x-2 pt-4">
                        <Button
                          variant="outline"
                          onClick={() => setEditChangeOrderDialogOpen(false)}
                        >
                          Cancel
                        </Button>
                        <Button
                          onClick={async () => {
                            try {
                              const { error } = await supabase.functions.invoke(
                                "change-orders",
                                {
                                  body: {
                                    ...
                                    assigned_approvers:
                                      editingChangeOrder.assigned_approvers ||
                                      [],
                                    approval_due_date:
                                      editingChangeOrder.approval_due_date,
                                    approval_notes:
                                      editingChangeOrder.approval_notes,
                              ...
                              toast({
                                ...
                                description:
                                  "The change order has been updated successfully.",
                              });
                            } catch (error: any) {
                              toast({
                                variant: "destructive",
              ...
              >
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Log a quality issue or incomplete work item for tracking
                      and resolution.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          value={newPunchListItem.category || "quality"}
                          onValueChange={(value) =>
                            setNewPunchListItem((prev) => ({
                              ...prev,
                              category: value,
                    ...
                    <div className="flex justify-end space-x-2">
                      <Button
                        variant="outline"
                        onClick={() => setAddPunchListDialogOpen(false)}
                      >
                        Cancel
                      </Button>
              ...
              <Dialog
                open={editPunchListDialogOpen}
                onOpenChange={setEditPunchListDialogOpen}
              >
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                  ...
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="edit-punch-description">
                        Description *
                      </Label>
                      <Textarea
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Select
                          value={editingPunchListItem?.priority || "medium"}
                          onValueChange={(value) =>
                            setEditingPunchListItem((prev) => ({
                              ...prev,
                              priority: value,
                      ...
                      <div>
                        ...
                        <Select
                          value={editingPunchListItem?.category || "quality"}
                          onValueChange={(value) =>
                            setEditingPunchListItem((prev) => ({
                              ...prev,
                              category: value,
                    ...
                    <div className="flex justify-end space-x-2">
                      <Button
                        variant="outline"
                        onClick={() => setEditPunchListDialogOpen(false)}
                      >
                        Cancel
                      </Button>
              ...
              >
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="equipment-manufacturer">
                          Manufacturer
                        </Label>
                        <Input
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="equipment-purchase-date">
                          Purchase Date
                        </Label>
                        <Input
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setAddEquipmentDialogOpen(false)}
                      >
                        Cancel
                      </Button>
              ...
              {/* Edit RFI Dialog */}
              <Dialog
                open={isEditRFIDialogOpen}
                onOpenChange={setIsEditRFIDialogOpen}
              >
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="edit-rfi-description">
                        Description *
                      </Label>
                      <Textarea
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setEditedRFI((prev) => ({ ...prev, status: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="edit-rfi-submitted-to">
                          Submitted To
                        </Label>
                        <Input
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      <Button
                        variant="outline"
                        onClick={() => setIsEditRFIDialogOpen(false)}
                      >
                        Cancel
                      </Button>
                      <Button onClick={handleUpdateRFI}>Update RFI</Button>
                    </div>
                  </div>
                </DialogContent>
              </Dialog>
              ...
              >
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Search and select an existing contact to add to this
                      project
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                      ...
                      <Card>
                        <CardContent className="pt-6">
                          <div className="flex items-center space-x-3 mb-4">
                            <div className="w-10 h-10 rounded-full bg-construction-blue flex items-center justify-center text-white text-sm font-medium">
                              {selectedContactToAdd.first_name?.[0]}
                              {selectedContactToAdd.last_name?.[0]}
                            </div>
                            <div>
                              <p className="font-medium">
                                {selectedContactToAdd.first_name}{" "}
                                {selectedContactToAdd.last_name}
                              </p>
