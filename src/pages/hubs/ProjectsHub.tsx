          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <projectsArea.icon className="h-6 w-6 text-construction-blue" />
                <div>
                  <h1 className="text-xl font-semibold">{projectsArea.title}</h1>
                  <p className="text-sm text-muted-foreground">{projectsArea.description}</p>
                </div>
              </div>
            </div>
          </div>
