    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          type="button"
          variant="outline"
          className="w-full bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 font-medium transition-all duration-200 shadow-sm hover:shadow group"
          disabled={loading}
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full bg-black hover:bg-gray-900 border border-gray-800 text-white font-medium transition-all duration-200 shadow-sm hover:shadow group"
          disabled={loading}
          onClick={handleAppleSignIn}
          aria-label="Sign in with Apple"
        >
          <svg className="mr-2 h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
