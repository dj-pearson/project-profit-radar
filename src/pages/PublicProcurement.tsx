...
import { Plus, Search, FileText, Users, Calendar, CheckCircle, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Public Procurement</h1>
          <p className="text-muted-foreground mt-2">
            Manage bid opportunities and subcontractor disclosures
          </p>
        </div>
