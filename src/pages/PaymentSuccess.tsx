...
import { CheckCircle, Receipt, Loader2, Home, FileText } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full">
        ...
        <p className="text-center text-sm text-muted-foreground mt-6 animate-in fade-in duration-700 delay-1000">
          ...
          <a href="mailto:support@brikly.net" className="text-construction-blue hover:text-construction-orange">
            Contact support
          </a>
        </p>
      </div>
