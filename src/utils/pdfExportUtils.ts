...
export class SchedulePDFExporter {
  ...
  private addHeader(): void {
    ...
    this.doc.text(this.options.companyName || 'Brikly', this.margin + 2, this.margin + 8);
  ...
  private addFooter(): void {
    ...
    this.doc.setFontSize(8);
    this.doc.setFont('helvetica', 'normal');
    this.doc.text('Generated by Brikly Construction Management Platform', this.margin, footerY + 8);
    this.doc.text(`Page 1 of 1`, this.pageWidth - this.margin, footerY + 8, { align: 'right' });
    this.doc.text('www.brikly.net', this.pageWidth / 2, footerY + 8, { align: 'center' });
  }
