  ...
  const createStage = async () => {
    try {
      ...
      const stageToInsert = {
        ...
        probability_weight: newStage.probability_weight,
        is_won_stage: newStage.is_won_stage,
        is_lost_stage: newStage.is_lost_stage,
        expected_duration_days: newStage.expected_duration_days,
        auto_tasks: JSON.stringify(newStage.auto_tasks || []) as Json,
        required_fields: JSON.stringify(newStage.required_fields || []) as Json,
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              setNewStage({ ...newStage, color_code: value })
                            }
                          >
                            <SelectTrigger>
                              <SelectValue />
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setNewStage({
                                ...newStage,
                                probability_weight: Number(e.target.value),
                              })
                            }
                          />
                        </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setNewStage({
                              ...newStage,
                              expected_duration_days: Number(e.target.value),
                            })
                          }
                        />
                      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Pipeline templates will allow you to create different
                  workflows for various deal types.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Set up automated lead assignment based on territory, source,
        ...
        >
          <DialogContent>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setEditingStage({ ...editingStage, color_code: value })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  <Label htmlFor="edit-stage-probability">
                    Probability Weight (%)
                  </Label>
                  <Input
              ...
              <div>
                <Label htmlFor="edit-stage-duration">
                  Expected Duration (days)
                </Label>
                <Input
