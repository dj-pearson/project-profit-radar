...
const BuildingModel: React.FC<{ progress: number; wireframe: boolean }> = ({ progress, wireframe }) => {
  ...
  // Enhanced wireframe materials with better colors and glow effects
  const foundationMaterial = {
    color: wireframe ? "#8B5CF6" : "#6B7280",
    wireframe: wireframe,
    transparent: true,
  ...
  return (
    <group ref={groupRef}>
      ...
      {/* Walls - Enhanced wireframe structure */}
      {wallsHeight > 0 && (
        <>
          {/* Front wall */}
      ...
      <div className="absolute bottom-4 left-4 right-4 bg-background/95 backdrop-blur-sm border border-border/50 rounded-xl p-4 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            >
              {wireframe ? 'Hide Blueprint' : 'Show Blueprint'}
            </button>
          </div>
