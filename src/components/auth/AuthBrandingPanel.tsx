...
import { Shield, BarChart3, Users, HardHat } from "lucide-react";
      ...
      <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
        <div>
          <Link to="/" className="inline-flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-lg shadow-black/20 group-hover:shadow-black/40 transition-shadow">
        ...
        <div className="space-y-8 max-w-lg">
          <div className="space-y-4">
            <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight">
              Build smarter.{' '}
              <span className="text-construction-orange">Profit more.</span>
            </h1>
          ...
          <div className="grid gap-4">
            {[
              ...
              <div key={feature.title} className="flex items-start gap-4 group">
                <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:border-construction-orange/40 transition-colors">
                  <feature.icon className="w-5 h-5 text-construction-orange" />
                </div>
                <div>
