...
export const Camera = {
  ...
  pickLimitedLibraryPhotos: () => Promise.reject(new Error('Camera not available on web')),
  getLimitedLibraryPhotos: () => Promise.reject(new Error('Camera not available on web')),
...
export const Device = {
  ...
  getBatteryInfo: () => Promise.resolve({
    batteryLevel: 1,
    isCharging: false
  }),
...
export const Filesystem = {
  ...
  appendFile: () => Promise.reject(new Error('Filesystem not available on web')),
...
export const Geolocation = {
  getCurrentPosition: () => Promise.reject(new Error('Geolocation requires user permission')),
  watchPosition: () => Promise.reject(new Error('Geolocation requires user permission')),
...
export const LocalNotifications = {
  schedule: () => Promise.reject(new Error('Local notifications not available on web')),
...
export const PushNotifications = {
  register: () => Promise.reject(new Error('Push notifications not available on web')),
