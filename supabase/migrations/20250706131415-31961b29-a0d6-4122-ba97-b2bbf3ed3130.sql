-- Create warranty management tables (fixed version)
CREATE TABLE public.warranties (
  ...
  warranty_end_date DATE, -- Will be calculated by trigger
...
-- Create trigger to calculate warranty end date
CREATE TRIGGER calculate_warranty_end_date_trigger
  BEFORE INSERT OR UPDATE OF warranty_start_date, warranty_duration_months ON public.warranties
  FOR EACH ROW
