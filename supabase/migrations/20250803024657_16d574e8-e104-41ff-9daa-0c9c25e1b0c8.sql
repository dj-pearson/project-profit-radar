...
-- Recreate the view WITHOUT SECURITY DEFINER to enforce RLS
...
COMMENT ON VIEW public.project_pl_summary IS 'Project profit/loss summary view - recreated without SECURITY DEFINER to enforce RLS';