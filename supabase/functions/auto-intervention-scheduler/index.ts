...
serve(async (req) => {
  ...
  try {
    ...
    console.log("[AUTO-INTERVENTION-SCHEDULER] Processing companies", { companyCount: companies?.length || 0 });
    ...
    console.log(
      `[AUTO-INTERVENTION-SCHEDULER] Scheduled ${allInterventions.length} interventions`
    );
