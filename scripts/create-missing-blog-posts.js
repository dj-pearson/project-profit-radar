// Script to create missing blog posts that are referenced in the sitemap
// This will create the blog posts in the Supabase database
...
async function createBlogPosts() {
  ...
  for (const post of blogPosts) {
    try {
      ...
      const { data, error } = await supabase
        ...
        .insert([{
          ...post,
          created_by: 'system' // You may need to adjust this based on your auth setup
        }])
        .select();
  ...
  console.log('Blog post creation complete!');
}
...
module.exports = { createBlogPosts, blogPosts };
