...
echo "  psql -h YOUR_HOST -U postgres -d postgres -f scripts/rollback-sql/ROLLBACK_multi_tenant.sql"
echo ""
...
echo "  2. Copy contents of: scripts/rollback-sql/ROLLBACK_multi_tenant.sql"
...
echo "📄 scripts/rollback-sql/ROLLBACK_multi_tenant.sql - Database rollback"
