...
All user-facing text, including documentation, in-app content, and marketing materials, should be **clear, concise, and professional**. Use straightforward language and avoid jargon to ensure easy understanding for all users.
...
The tone of voice for all user interactions (e.g., error messages, notifications, support responses) should be **helpful, reassuring, and solution-oriented**. We aim to foster trust and provide a positive user experience, especially when users need assistance.
